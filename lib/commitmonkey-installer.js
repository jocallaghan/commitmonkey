...
function initHook() {
    ...
    // This is to allow IDEs to execute the hook in their minimal environment
    hookContent = hookContent
        .replace('__NODE_PATH__', getNodePath())
        .replace('__COMMITMONKEY_HOOK_PATH__', getCodemonkeyPath());
